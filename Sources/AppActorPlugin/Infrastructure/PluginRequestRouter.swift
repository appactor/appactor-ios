...
enum AppActorPluginRequestRouter {
    ...
    static var registry: [String: any AppActorPluginRequest.Type] = {
        var requests: [any AppActorPluginRequest.Type] = [
            ...
            SetAttributesRequest.self,
            SetAttributeRequest.self,
            UnsetAttributeRequest.self,
            SetEmailRequest.self,
            SetDisplayNameRequest.self,
            ...
            SetCampaignRequest.self,
            SetAdGroupRequest.self,
            SetAdRequest.self,
            SetKeywordRequest.self,
            SetCreativeRequest.self,
